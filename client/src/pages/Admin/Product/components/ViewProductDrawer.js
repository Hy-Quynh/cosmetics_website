...
import PlaceholderImage from '../../../../assets/imgs/placeholder.png';
  ...
  const getAllReview = async (page) => {
    try {
      ...
      if (reviewRes?.success) {
        setProductReview(reviewRes.payload.review);
          ...
          {productDetailTab === 0 ? (
            <Box sx={{ padding: "20px" }}>
              ...
              >
                ...
                <Box sx={inputStyle}>
                  {Number(initData?.sale_price) > 0 &&
                  Number(initData?.sale_price) !==
              ...
              >
                <Box sx={{ width: "20%" }}>
                  <div style={{ color: "#1876D1" }}>Số nhập nhập vào: </div>
                </Box>
                <Box sx={inputStyle}>{initData?.init_quantity}</Box>
              </Stack>
              ...
              >
                <Box sx={{ width: "20%" }}>
                  <div style={{ color: "#1876D1" }}>Số lượng hiện tại: </div>
                </Box>
                <Box sx={inputStyle}>{initData?.current_quantity}</Box>
              </Stack>
              <Stack
                flexWrap="nowrap"
                flexDirection={"row"}
                          ...
                          >
                            ...
                            >
                              ...
                              <div style={{ marginLeft: "15px" }}>
                                <div
                                  onClick={async () => {
                                    const deleteRes = await productAPI.deleteReviewData(
                                      reviewItem?._id
                                    );
                              ...
                              <div
                                ...
                                onClick={async () => {
                                  const updateRes = await productAPI.updateReviewStatus(
                                    reviewItem?._id,
